...
- **Action layer**: necessary actuations (only from Resolution)

---

## Recommended prompts (examples)

- “Mark all generated claims as Hypothesis. Do not state them as Fact.”
- “Identify any part of this request that asks for a final decision, and decline it.”
- “Generate an anomaly report draft for review. Explicitly state assumptions.”

---

## Compatibility

See `analytics_llm.yaml`.
